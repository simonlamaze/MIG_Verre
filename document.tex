...
\begin{document}
    ...
    Le modèle est simpliste en raison du peu de données disponible et de la complexité du phénomène étudié . Voici la régression, en bleu le modèle, en orange les données: \\
